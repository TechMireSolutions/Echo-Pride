...
export default function CurrencySelector({ align = 'right', variant = 'dark' }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          className={`absolute ${align === 'right' ? 'right-0' : 'left-0'} top-full mt-3 w-64 bg-white text-gray-900 shadow-2xl border border-gray-100 rounded-lg py-2 z-50 max-h-[420px] overflow-y-auto`}
        >
